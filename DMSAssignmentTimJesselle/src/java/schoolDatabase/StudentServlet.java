...
//      sqlCommand = "SELECT " + dbIDAtt + " AS 'STUDENT ID'," + dbFirstAtt
//         + " AS 'FIRST NAME'," + dbLastAtt + "AS 'LAST NAME' FROM " + dbTable;
...
//      response.setContentType("stylesheet/css;styles.css");
      try (PrintWriter out = response.getWriter())
      {
         ...
         out.println("<h3>Active User: "+user.getUsername()+"\n");
//         out.println("<c:if test=\"${not empty requestScope.CurrentUser}\">\n");
//         out.println("<c:out value=\"${CurrentUser.username}\"/>\n");
//         out.println("</c:if>\n" );
         out.println("</h3>");
